...
<body>
    ...
    <?php
        include 'config.php';
        $sql = "SELECT * FROM customers.customerinformation";
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : rgb(20, 5, 107);;">Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
